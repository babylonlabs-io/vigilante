...
func (m *MockBabylonNodeAdapter) DelegationsByStatus(status types0.BTCDelegationStatus, cursor []byte, limit uint64) ([]Delegation, []byte, error) {
	m.ctrl.T.Helper()
...
func (mr *MockBabylonNodeAdapterMockRecorder) DelegationsByStatus(status, cursor, limit interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
